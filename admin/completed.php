...
<?php
     ...
     if(isset($_GET['id'])){
        ...
        $sql = "DELETE FROM appointment WHERE id = $id_name";
     ...
     if (!isset($_SESSION['username'])){
        ...
        $sql = "SELECT * FROM appointment WHERE status = 'completed' ORDER BY date_issue ASC";
        $message = $conn->query($sql) or die ($conn->error);
        ...
        $purpose1 = "SELECT id FROM appointment WHERE purpose = 'Sign of documents' AND status = 'completed'";
        $purpose1_run = mysqli_query($conn, $purpose1);
        $purpose1_count = mysqli_num_rows($purpose1_run);

        $purpose2 = "SELECT id FROM appointment WHERE purpose = 'Year book' AND status = 'completed'";
        $purpose2_run = mysqli_query($conn, $purpose2);
        $purpose2_count = mysqli_num_rows($purpose2_run);

        $purpose3 = "SELECT id FROM appointment WHERE purpose = 'Diploma' AND status = 'completed'";
    ...
    <div class="d-flex" id="wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a class="list-group-item list-group-item-action bg-transparent second-text active" href id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"><i 
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="list-group-item list-group-item-action bg-transparent second-text active" href="completed.php">Completed</a></li>                        
                    </ul>
                    <!-- </div> -->
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">E-mail Completed</h3>
                    <div class="col">
				...
				<thead>
                            ...
                            <?php do{ ?>
                                <tr>
                                    ...
                                    <td scope="row">                                        
                                        <a title="Delete" href='completed.php?id=<?php echo $row['id']?>' class="btn btn-outline-danger btn-block"><i class="fa-solid fa-delete-left"></i>Remove</a>   
                                    </td>
